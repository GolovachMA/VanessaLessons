...
Сценарий: Открытие формы объекта "REP_Barcodes"

	Дано Я открываю основную форму отчета "REP_Barcodes"
	Если появилось предупреждение тогда
		Тогда я вызываю исключение "Не удалось открыть форму отчета REP_Barcodes"
	И Я закрываю текущее окно
